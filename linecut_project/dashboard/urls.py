...
urlpatterns = [
    ...
    path('configuracoes/save-fcm-token/', views.save_fcm_token, name='save_fcm_token'),
    ...
    path('notificacoes/data/', views.get_notificacoes_data, name='get_notificacoes_data'),
    path('notificacoes/mark-all-read/', views.mark_notificacoes_read, name='mark_notificacoes_read'),
    path('notificacoes/delete-read/', views.delete_read_notificacoes, name='delete_read_notificacoes'),
    path('notificacoes/unread-count/', views.get_unread_notification_count, name='get_unread_count'),
